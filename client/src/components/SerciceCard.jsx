    ...
    <>
      <Link to={`/service/${id}`} className="group">
        <div className="w-full h-64 overflow-hidden bg-gray-200 rounded-lg shadow-xl aspect-w-1 xl:aspect-h-8 xl:aspect-w-7">
          <div className="z-10 w-full h-full overflow-hidden transition duration-300 ease-in-out rounded-xl opacity-80 group-hover:opacity-100 dark:border-gray-700 dark:opacity-70">
            <img
